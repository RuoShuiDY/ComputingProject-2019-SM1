        ...
        <div class="row" id="page">
          ...
          <nav id="sidebar" class="bg-light navbar-light col-xs-2 col-sm-2 col-md-2 col-lg-2">
            <ul class="list-unstyled">
                <li class="nav-item">
                  <a class="nav-link active" href="dashboard.html"><i class="fa fa-dashboard"></i><span>Dashboard</span></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  ...
                  <ul class="collapse list-unstyled" id="emailSubmenu">
                    <li>
                      <a class="nav-link" href="#"><span>Individual Sending</span></a>
                    </li>
                    <li>
                      <a class="nav-link" href="#"><span>Group Sending</span></a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#"><i class="fa fa-bar-chart-o"></i><span>Score Charts</span></a>
                </li>
              </ul>
          </nav>
