          ...
          <ul class="list-unstyled">
              ...
              <li class="nav-item">
                ...
                <ul class="list-unstyled" id="markerSubmenu">
                  <li>
                    <a class="nav-link active" href="/tutor/tutor_invite_list"><span>Marker Invitation</span></a>
                  </li>
                  <li>
              ...
              <div class="form_vertical inviteMarker" style="display:none">
                ...
                <form class="popup_form" action="invite_tutor" method="post">
                  ...
                  <div class="popup_form_row">
                    <label for="email"><span class="badge badge-secondary check_email"></span> Marker Email:</label>
                    <input type="email" class="showTooltip" name="email" id="email" value="" autocomplete="off"/>
                  </div>
                  <div class="popup_form_row">
