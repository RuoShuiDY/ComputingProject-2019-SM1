          ...
          <ul class="list-unstyled">
              ...
              <li class="nav-item">
                ...
                <ul class="list-unstyled" id="markerSubmenu">
                  ...
                  <li>
                    <a class="nav-link active" href="/tutor/overview"><span>Marker Overview</span></a>
                  </li>
                </ul>
              </li>
              <li class="nav-item">
              ...
              <div class="form_vertical updateMarker" style="display:none">
                ...
                <form class="popup_form" action="updateInfo" method="post">
                  ...
                  <div class="popup_form_row">
                    <label><span class="badge badge-secondary"></span> Marker ID:</label>
                    <label class="showTooltip marker-id-label showLabel"></label>
                  </div>
                  <div class="popup_form_row">
                    <label><span class="badge badge-secondary"></span> Marker Email:</label>
                    <label class="showTooltip marker-email-label showLabel"></label>
                  </div>
                  <div class="popup_form_row">
                    <label><span class="badge badge-secondary"></span> Marker Name:</label>
                    <label class="showTooltip marker-name-label showLabel"></label>
                  </div>
                  <div class="popup_form_row">
                    <label><span class="badge badge-secondary"></span> Contact:</label>
                    <label class="showTooltip marker-contact-label showLabel"></label>
                  </div>
                  <div class="popup_form_row">
                    ...
                    <datalist id="subject">
                      <c:forEach items="${lesson }" var="lesson">
	                      <option data-id="${lesson.lessonId}" value="${lesson.classDict.classId } ${lesson.semester } ${lesson.year }"></option>
	                    </c:forEach>
                      <!-- 
