      ...
      <div class="row" id="page">
        ...
        <nav id="sidebar" class="bg-light navbar-light col-xs-2 col-sm-2 col-md-2 col-lg-2 visible">
          <ul class="list-unstyled">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="/lesson/lessonlist"><i class="fa fa-book"></i><span>Subject Information</span></a>
              </li>
              <li class="nav-item">
              ...
              <div class="form_vertical addSubject" style="display:none">
                ...
                <form class="popup_form" action="addlesson" method="post">
                  ...
                  <div class="popup_form_row">
                    ...
                    <input type="text" name="class_id" id="subjectid_add_input" class="showTooltip" list="subject" autocomplete="off">
                    <datalist id="subject">
                  ...
                  <label for="semester">Semester:</label>
                    <select class="showTooltipSelect" name="semester" id="semester">
                  ...
                  <div class="popup_form_row">
                    ...
                    <input type="text" class="yearpicker showTooltip" value="" name="year" id="year"/>
                    <script src="../../assets/js/yearpicker.js" async></script>
                  </div>
                  <div class="row">
                    <button type="submit" name="button" class="form_vertical_button disabled col-lg-5 col-md-5 col-sm-5 col-xs-5" id="add_submit"><i class="fa fa-plus"></i><span>Add</span></button>
              ...
              <div class="form_vertical updateSubject" style="display:none">
                ...
                <input id="hidden_lesson_id" type="hidden" name="lesson_id" />
                  ...
                  <div class="popup_form_row">
                    ...
                    <label class="showTooltip subjectid-label"></label>
                  </div>
                  <div class="popup_form_row">
                    <label for="semester">Semester:</label>
